...
public class FirebaseMessagingModule extends ReactContextBaseJavaModule {
    ...
    public void sendDataToReact(String title)
    {
        System.out.println("the title from other side is "+title);
        ...
        System.out.println("after emit "+title);
    }

    @ReactMethod
    public void getMessageFromKilledState()
    {
